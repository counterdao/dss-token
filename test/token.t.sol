...
contract DSSTokenTest is Test, ERC721TokenReceiver {
    ...
    function test_mint_creates_counter() public {
        token.mint{ value: 0.01 ether }();
        assertEq(address(token.count(1)), dss.scry(address(token), bytes32(uint256(1)), address(0)));

        token.mint{ value: 0.01 ether }();
        assertEq(address(token.count(2)), dss.scry(address(token), bytes32(uint256(2)), address(0)));
    }
    ...
    function xtest_returns_token_uri() public {
        token.mint{ value: 0.01 ether }();
        assertEq(token.tokenURI(1), "data:application/json;base64,");
    }
